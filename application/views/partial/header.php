...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . $this->lang->line('common_powered_by') . ' BYOOSPOS ' . $this->config->item('application_version') ?></title>
	...
	<?php if ($this->input->cookie('debug') == 'true' || $this->input->get('debug') == 'true') : ?>
		<!-- bower:css -->
		<link rel="stylesheet" href="public/public/bower_components/jquery-ui/themes/base/jquery-ui.css" />
		<link rel="stylesheet" href="public/public/bower_components/bootstrap3-dialog/dist/css/bootstrap-dialog.min.css" />
		<link rel="stylesheet" href="public/public/bower_components/jasny-bootstrap/dist/css/jasny-bootstrap.css" />
		<link rel="stylesheet" href="public/public/bower_components/smalot-bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" />
		<link rel="stylesheet" href="public/public/bower_components/bootstrap-select/dist/css/bootstrap-select.css" />
		<link rel="stylesheet" href="public/public/bower_components/bootstrap-table/src/bootstrap-table.css" />
		<link rel="stylesheet" href="public/public/bower_components/bootstrap-table/dist/extensions/sticky-header/bootstrap-table-sticky-header.css" />
		<link rel="stylesheet" href="public/public/bower_components/bootstrap-daterangepicker/daterangepicker.css" />
		<link rel="stylesheet" href="public/public/bower_components/chartist/dist/chartist.min.css" />
		<link rel="stylesheet" href="public/public/bower_components/chartist-plugin-tooltip/dist/chartist-plugin-tooltip.css" />
		<link rel="stylesheet" href="public/public/bower_components/bootstrap-tagsinput/dist/bootstrap-tagsinput.css" />
		<link rel="stylesheet" href="public/public/bower_components/bootstrap-toggle/css/bootstrap-toggle.min.css" />
		<!-- endbower -->
		...
		<script src="public/bower_components/bootstrap-toggle/js/bootstrap-toggle.min.js"></script>
		<!-- endbower -->
	...
	<?php else : ?>
		...
		<link rel="stylesheet" type="text/css" href="public/dist/opensourcepos.min.css?rel=397f582d3d"/>
		<!-- end mincss template tags -->
		<!-- start minjs template tags -->
		<script type="text/javascript" src="public/dist/opensourcepos.min.js?rel=d08916b862"></script>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>">BYOOSPOS</a>
				</div>
