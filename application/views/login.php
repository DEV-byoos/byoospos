...
<head>
	...
	<title><?php echo $this->config->item('company') . ' BOOSOSPOS ' . $this->config->item('application_version')  . ' | ' .  $this->lang->line('login_login'); ?></title>
	<link rel="shortcut icon" type="image/x-icon" href="images/favicon.ico">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'public/dist/bootswatch/' . (empty($this->config->item('theme')) ? 'flatly' : $this->config->item('theme')) . '/bootstrap.min.css' ?>"/>
...
<body>
	...
	<div id="login">
		...
		<h1>BYOOS Point Of Sale <?php echo $this->config->item('application_version'); ?></h1>
